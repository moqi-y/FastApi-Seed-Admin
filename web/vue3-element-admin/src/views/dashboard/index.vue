    ...
    <el-card shadow="never" class="mt-2">
      <div class="flex flex-wrap">
        ...
        <div class="flex-1 flex items-start">
          ...
          <div class="ml-5">
            <p>{{ greetings }}</p>
            <p class="text-sm text-gray">{{ dailySentence }}</p>
          </div>
        </div>
      </div>
    </el-card>
...
const dailySentence = computed(() => {
  let list = [
    "夜阑风静欲归时，惟有一江明月碧琉璃。——苏轼《虞美人·有美堂赠述古》", "竹外桃花三两枝，春江水暖鸭先知。——苏轼《惠崇春江晚景》",
    "云想衣裳花想容，春风拂槛露华浓。——李白《清平调·其一》", "五陵年少金市东，银鞍白马度春风。——李白《少年行二首》",
    "无边落木萧萧下，不尽长江滚滚来。——杜甫《登高》", "正是江南好风景，落花时节又逢君。——杜甫《江南逢李龟年》",
    "好雨知时节，当春乃发生。——杜甫《春夜喜雨》", "山有木兮木有枝，心悦君兮君不知。——佚名《越人歌》"
  ];
